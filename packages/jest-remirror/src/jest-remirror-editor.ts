...
export class RemirrorTestChain<ExtensionUnion extends AnyExtension> {
   ...
   * The editor view.
   */
  get view(): TestEditorView<GetSchema<ExtensionUnion>> {
    return this.manager.view as TestEditorView<GetSchema<ExtensionUnion>>;
  }

  /**
   * The editor state.
   */
  get state(): EditorState<GetSchema<ExtensionUnion>> {
   ...
   * The editor schema.
   */
  get schema(): GetSchema<ExtensionUnion> {
   ...
   */
  get doc(): ProsemirrorNode<GetSchema<ExtensionUnion>> {
   ...
   */
  get commands(): CommandsFromExtensions<ExtensionUnion> {
   ...
   * will throw errors due to using an outdated state.
   */
  get chain(): ChainedFromExtensions<ExtensionUnion> {
   ...
   */
  get active(): ActiveFromExtensions<ExtensionUnion> {
   ...
   */
  get helpers(): HelpersFromExtensions<ExtensionUnion> {
  ...
  private setupCloneListener() {
    const dispose = this.#manager.addHandler('clone', (newManager) => {
      this.#manager = newManager as RemirrorManager<ExtensionUnion>;
   ...
   */
  readonly add = (taggedDocument: TaggedProsemirrorNode<GetSchema<ExtensionUnion>>): this => {
   ...
   * Alias for add.
   */
  readonly overwrite = (taggedDocument: TaggedProsemirrorNode<GetSchema<ExtensionUnion>>): this => {
