...
import { pascalCase } from 'remirror';
import { AnyRemirrorManager, EditorState, FromToParameter, object, RemirrorJSON } from 'remirror';
...
export function createDebugComponent(name: string): ComponentType<DebugComponentProps> {
  const DebugComponent = (props: DebugComponentProps) => {
    ...
    console.log('MAP', JSON.stringify(map[key]?.content, null, 2));
    ...
    useLayoutEffect(() => {
      ...
      console.log('FIRST RENDER', JSON.stringify(debugState?.content, null, 2));
