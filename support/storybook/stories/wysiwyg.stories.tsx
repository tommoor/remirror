...
import {
  ...
  ItalicIcon,
  UnderlineIcon,
} from '@remirror/react-components/icons';
  ...
  return (
    <Form {...form}>
      <FormLabel {...form} name='source'>
        {i18n._(messages.imageDialogSourceLabel)}
      </FormLabel>
      ...
      <FormLabel {...form} name='description'>
        {i18n._(messages.imageDialogDescriptionLabel)}
      </FormLabel>
      <FormInput
        {...form}
        name='description'
        placeholder={i18n._(messages.imageDialogDescriptionPlaceholder)}
      />
    ...
    <>
      ...
      <Menu {...menu} aria-label='More items'>
        <MenuItem {...menu} as='div'>
          <H1Icon /> {i18n._(messages.h1)}
        </MenuItem>
        <MenuItem {...menu} as='div'>
          <H2Icon /> {i18n._(messages.h2)}
        </MenuItem>
        <MenuItem {...menu} as='div'>
          <H3Icon /> {i18n._(messages.h3)}
        </MenuItem>
      </Menu>
    </>
  );
...
const DialogToolbarMenuItem = (props: DialogToolbarMenuItemProps) => {
  ...
  return (
    <>
      ...
      <Tooltip {...tooltip}>{label}</Tooltip>
      <EditorDialog dialog={dialog} label={i18n._(messages.imageDialogLabel)}>
        {children}
      </EditorDialog>
    </>
  );
  ...
  return (
    <Toolbar {...toolbar}>
      ...
      <ToggleToolbarMenuItem
        ...
        icon={<UnderlineIcon />}
        label={i18n._(messages.underline)}
      />
